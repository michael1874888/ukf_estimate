...
Eigen::MatrixXd dynamics(Eigen::MatrixXd sigma_state){
    ...
    for(int i=0;i<x_sigmavector_size;i++){
        ...
        double A = sigma_state(member_A,i);
        double x1_ ;
        double x2_ ;
        double x3_ ;
        double A_;
        ...
        predict_sigma_state(member_A,i) =  A_;
...
Eigen::MatrixXd state_to_measure(Eigen::MatrixXd sigma_state){
    ...
    for(int i=0;i<x_sigmavector_size;i++){
        ...
        predict_sigma_measure( member_myc ,i) =    - rel_posec2g(1);
        predict_sigma_measure( member_mzc ,i) =   0.75 - rel_posec2g(2);
